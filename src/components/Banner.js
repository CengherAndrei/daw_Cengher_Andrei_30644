                    ...
                    <div className="row">
                        <div className="col-lg-6 mx-auto">
                            <div className="banner-area text-center pt-4 pb-4">
                                <h2 className="mt-2 mb-4 banner-title"><strong>Cauta Locuinta Potrivita Cu ACF Real Estate</strong> </h2>
                                <p>Alaturi de ACF Real Estate scapi de orice grija legata de confortul tau de acasa</p>
