                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <h1 className="page-title">Inchirieri</h1>
                            <h2 className="page-description">Inchirieri</h2>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    {spaces && spaces.length > 0 ? (
                                        spaces.filter(space => space.type==="casa").map((filterspace) => (
                                            <div className="space" key={filterspace.id}>
                                                <BestFlatItem id={filterspace.id} flatState="For Rent" descriere={filterspace.address} pret={filterspace.price} suprafata={filterspace.surface}/>
                                            </div>
                                        ))
                                    ) : (
